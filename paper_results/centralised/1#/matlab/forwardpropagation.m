function [reduction] = forwardpropagation(param_dict,KS)
...
%% forward propagation 
[g_1f, g_2f, g_3f, g_4f, g_5f] = forward_propagation(param_dict, KS); % swap in forward_propagation
...
% 
reduction = dictionary([1,2,3,4,5], {v_1f, v_2f, v_3f, v_4f, v_5f});
% 
% %% plot forward vs backward
% figure;
